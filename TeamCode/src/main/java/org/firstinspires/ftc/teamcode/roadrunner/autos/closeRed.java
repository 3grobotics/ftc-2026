...
@Config
@Autonomous(name = "Daini no Bakudan RED(RSR close A)", group = "competition")
public class closeRed extends LinearOpMode {
    ...
    public class turret {
        ...
        public turret(HardwareMap hardwareMap) {
            ServoImplEx turret1 = hardwareMap.get(ServoImplEx.class, "turret");
            ServoImplEx turret2 = hardwareMap.get(ServoImplEx.class, "turret2");
